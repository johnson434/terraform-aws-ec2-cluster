...
run "when_sg_and_ingress_ref_sg_rule_created_then_ingress_resource_length_is_1" {
  variables {
    create_sg   = true
    vpc_id      = "vpc-id"
    name        = "test-sg"
...
run "when_sg_and_ingress_cidripv4_sg_rule_created_then_ingress_resource_length_is_1" {
  variables {
    create_sg   = true
    vpc_id      = "vpc-id"
    name        = "test-sg"
...
run "when_sg_and_ingress_cidripv6_sg_rule_created_then_ingress_resource_length_is_1" {
  variables {
    create_sg   = true
    vpc_id      = "vpc-id"
    name        = "test-sg"
